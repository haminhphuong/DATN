...
namespace Ecommage\BannerManager\Block\Adminhtml\Widget;

/**
 *  chooser banner for slider widget
 */
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Ecommage\BannerManager\Model\ResourceModel\Banner\CollectionFactory $collectionFactory
     * @param array                                                           $data
     */
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl('banner/slider_widget/chooser', ['uniq_id' => $uniqId]);
        ...
        if ($element->getValue()) {
            $block = $this->_bannerFactory->create()->load($element->getValue());
            if ($block->getId()) {
    ...
    /**
     * Prepare Cms static banners collection
     *
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index'   => 'type_id',
                'type'    => 'options',
                'options' => [1 => __('Slider'), 2 => __('Banner')]
            ]
        );
    ...
    {
        return $this->getUrl('banner/slider_widget/chooser', ['_current' => true]);
    }
}
