...
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'banner_collection';
    ...
    {
        $this->_init(
            \Ecommage\BannerManager\Model\Banner::class,
            \Ecommage\BannerManager\Model\ResourceModel\Banner::class
        );
    ...
    protected function _afterLoad()
    {
        ...
        $this->performAfterLoad('banner_store', $entityMetadata->getLinkField());
    ...
    {
        return $this->_toOptionArray(BannerInterface::BANNER_ID, BannerInterface::TITLE);
    }
    ...
    {
        $entityMetadata = $this->metadataPool->getMetadata(BannerInterface::class);
        $this->joinStoreRelationTable('banner_store', $entityMetadata->getLinkField());
    }
