<?php
namespace Ecommage\CustomMagentoWishlist\Plugin\Model;
...
class ItemCarrier
{
     ...
     */
    public function aroundMoveAllToCart(\Magento\Wishlist\Model\ItemCarrier $subject, callable $proceed, Wishlist $wishlist, $qtys)
    {
        ...
        foreach ($collection as $item) {
            ...
            try {
                ...
                // Add to cart
                if($item->getProduct()->getPrice() == 0 && $item->getProduct()->getTypeId() != "bundle"){
                    $flag = true;
                }else{
        ...
        if($flag){
            $messages[] = __('Unable to add to cart product with contact price.');
        }
