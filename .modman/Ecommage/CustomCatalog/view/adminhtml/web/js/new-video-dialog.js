...
define([
    ...
    $.widget('mage.newVideoDialog', {
        ...
        _onGetVideoInformationSuccess: function (e, data) {
            var self = this;
            if(!$(this.options.DOM.titleField).val()){
                $(this.options.DOM.titleField).val(data.title);
            }
            if(!$(this.options.DOM.descriptionField).val()){
                $(this.options.DOM.descriptionField).val(data.description);
            }
