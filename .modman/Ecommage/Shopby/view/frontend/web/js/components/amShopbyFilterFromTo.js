...
define([
    ...
    $.widget('mage.amShopbyFilterFromTo', $.mage.amShopbyFilterAbstract, {
        ...
        onSyncChange: function (event, values) {
            ...
            this.element.find(this.selectors.dataFromTo.replace('{mode}', 'from')).val(parseInt(from));
            this.element.find(this.selectors.dataFromTo.replace('{mode}', 'to')).val(parseInt(to));
        },
