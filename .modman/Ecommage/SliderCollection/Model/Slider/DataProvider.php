...
namespace Ecommage\SliderCollection\Model\Slider;
 ...
 * Class DataProvider
 *
 * @package Ecommage\SliderCollection\Model\Slider
 */
class DataProvider extends AbstractDataProvider
{

    /**
     * @var \Ecommage\SliderCollection\Model\ResourceModel\Slider\Collection
     */
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('ecommage_slider');
        if (!empty($data)) {
            $model = $this->collection->getNewEmptyItem();
            $model->setData($data);
            $this->loadedData[$model->getId()] = $model->getData();
            $this->dataPersistor->clear('ecommage_slider');
        }
        return $this->loadedData;
    }
