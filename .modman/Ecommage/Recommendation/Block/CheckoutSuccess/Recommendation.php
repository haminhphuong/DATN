<?php
namespace Ecommage\Recommendation\Block\CheckoutSuccess;
...
class Recommendation extends AbstractProduct
{
     ...
     * @var string
     */
    protected $_template = 'Ecommage_Recommendation::recommendation/checkout-success.phtml';
    ...
    public function getCollection(){
        ...
        if($ids){
            ...
            if($this->helper->getType() == self::RECOMMENDATION_FOR_YOU){
                $this->helper->setTitle($this->helper->titleCheckoutSuccessRecommendedForYou());
            }
        }
        return $collection;
    }
