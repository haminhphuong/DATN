<?php
namespace Ecommage\Recommendation\Controller\ProductList;
...
class Recommendation extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $block = $this->layoutFactory->create()->createBlock(
            \Ecommage\Recommendation\Block\ProductList\Recommendation::class,
            'product.list.recommendation'.$type,
            [
                'data' => [
                    'productIds' => $ids,
                    'type'=>$type,
        ...
        $html = $this->helper->convertWebp($block->toHtml(),'catalog_category_view');
